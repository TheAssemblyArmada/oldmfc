...
#define AFX_DBG1_SEG    _TEXTSEG(AFX_DBG1)  // inlines go here in _MFC_DEBUG
#define AFX_DBG2_SEG    _TEXTSEG(AFX_DBG2)  // inlines go here in _MFC_DEBUG
...
#define AFX_DBG1_SEG                        // inlines go here in _MFC_DEBUG
#define AFX_DBG2_SEG                        // inlines go here in _MFC_DEBUG
...
//  _MFC_DEBUG              debug versions (full diagnostics)
...
#ifndef AFX_NOVTABLE
#if _MSC_VER >= 1100 && !defined(_MFC_DEBUG)
